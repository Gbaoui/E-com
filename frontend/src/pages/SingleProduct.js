                    ...
                    <div className="main-product-details">
                        ...
                        <div className="border-bottom py-3">
                            ...
                            <div className='d-flex align-items-center gap-15'>
                                ...
                                <div>
                                    <a href=""> <BsHeart className='fs-5 me-2' /> Add to Wishlist</a>
                                </div>
                            </div>
                            <div className='d-flex gap-10 align-items-center my-2x'>
                ...
                <div className="row">
                    ...
                    <h4>Description</h4>
                        ...
                        <p>
                            ...
                            Eos nulla minima quis id atque hic provident, libero sint ipsum 
                            vel sit dicta impedit totam eius iure magni voluptatem. 
                            Veniam, optio.
                        </p>
                        </div>
                    </div>
      ...
      <Container  class1="reviews-wrapper home-wrapper-2">
            <div className="row">
                <div className="col-12">
                    ...
                    <p className='mt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi non suscipit recusandae officiis? Iusto, error fugiat autem ipsa laboriosam sequi iste harum modi sint placeat, minus similique amet porro aut.</p>
                    </div>
                    </div>
                    </div>
                </div>
